...
import {AcceptPaymentModel} from '../financeModels/acceptPaymentModel';
import Highcharts from 'highcharts';
import dataModule from "highcharts/modules/data";
import $ from 'jquery';
class StudentFinanceDetail extends Component{
   constructor(props){
      super(props);
      this.state={
...
<div className="col-md-9">
   ...
   <div className="c-repoCard">
      <div className="row">
         ...
         <div className="col-md-6">
               ...
               <div className="divider-container nomargin">
                     <div className="divider-block text--left">
                        <button className="c-btn-large primary"  data-toggle="modal" data-target="#acceptpayment">Accept Payment</button>
                     </div>
               </div>
               <div className="divider-container margin0-bottom">
                     <div className="divider-block text--left">
                        <button className="c-btn-large">Send Payment Reminders</button>
                     </div>
                     <div className="divider-block text--left">
                           <button className="c-btn-large" onClick={this.goToCreateNewInvoice.bind(this)}>Create New Invoice</button>
                        </div>
               </div>
         </div>
   ...
   <div className="clearfix">
                                    ...
                                    <tbody>
                                          <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <button className="c-btn sm margin0-bottom">Accept Payment</button>
                                                </td>
                                          </tr>
                                          <tr>
                                                <td><span className="c-name">4659</span></td>
         ...
         <div className="panel-group c-panelAccord type-1" id="record5" role="tablist" aria-multiselectable="true">
            ...
            <AcceptPaymentModel data={this.props}/>
         </div>
      )
   }
}

export default StudentFinanceDetail