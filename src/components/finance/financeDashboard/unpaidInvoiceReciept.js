...
class UnpaidInvoiceReciept extends Component{
    constructor(props) {
        super(props);
        this.state = {
				...
				<div className="clearfix">
					<div className="divider-container">
						...
						<div className="divider-block text--right">
							<button className="c-btn">Accept Payment</button>
							<button className="c-btn">Download Invoice</button>
						</div>
					</div>
				</div>
							...
							<div className="c-invoiceContainer">
								...
								<div className="invoiceHeader">
									...
									<div className="row margin25-bottom">
										...
										<div className="col-md-2 paidInvoiceImage"></div>
									...
									<div className="row">
										...
										<div className="col-md-4">
											<div className="invoiceDtls_due">
												<span className="dueHeading">DUE</span>
												<span className="dueData">₹ 20,600.00</span>
											</div>
										</div>
									</div>
									...
									<div className="row">
										...
										<div className="col-md-7">
											...
											<div className="clearfix infoBox">
												<span className="infoBox_title">BANK TRANSFER</span>
												<div className="invoiceDtls_list type-01">
													<ul>
														<li>
															<span className="key">Bank Name</span>
															<span className="value">Bank of India</span>
														</li>
														<li>
															<span className="key">Account No.</span>
															<span className="value">2321432234234</span>
														</li>
														<li>
														...
														<li>
															...
															<span className="value">Pune Branch</span>
														</li>
													</ul>
												</div>
											</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(UnpaidInvoiceReciept)