...
export class StudentPaymentModel extends Component{
   constructor(props){
      super(props);
      this.state={
   ...
   render(){
      return(
         <div className="modal fade" id="studentPayment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div className="modal-dialog" role="document">
					<div className="modal-content">
						<div className="modal-header">
							...
							<h4 className="c-heading-sm card--title">Pay Now</h4>
						</div>
						...
						<div className="modal-footer">
							<div className="clearfix text--right">
								...
								<button className="c-btn primary">Pay</button>
							</div>
						</div>
					</div>
				</div>
